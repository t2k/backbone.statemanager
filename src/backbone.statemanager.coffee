###
Backbone.Statemanager, v0.5.0  AMD wrapper Ted Killilea, lrrs259@gmail.com
...
((root, factory) ->
  ...
  Backbone.StateManager = ((_, Backbone) ->
    ...
    _.extend StateManager::, Backbone.Events,
  ...
  Backbone.StateManager.VERSION = '0.5.0'
  Backbone.StateManager.noConflict = ->
